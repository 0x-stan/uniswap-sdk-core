...
var SUPPORTED_CHAINS = [ChainId.MAINNET, ChainId.ZKSYNC_ERA, ChainId.ZKSYNC_ERA_SEPOLIA, ChainId.ZKSYNC_ERA_INMEMORY, ChainId.OPTIMISM, ChainId.OPTIMISM_GOERLI, // ChainId.OPTIMISM_SEPOLIA,
ChainId.ARBITRUM_ONE, ChainId.ARBITRUM_GOERLI, // ChainId.ARBITRUM_SEPOLIA,
ChainId.POLYGON, ChainId.POLYGON_MUMBAI, // ChainId.GOERLI,
ChainId.SEPOLIA, ChainId.CELO_ALFAJORES, ChainId.CELO];
...
var CHAIN_TO_ADDRESSES_MAP = (_CHAIN_TO_ADDRESSES_M = {}, _CHAIN_TO_ADDRESSES_M[ChainId.MAINNET] = MAINNET_ADDRESSES, _CHAIN_TO_ADDRESSES_M[ChainId.SEPOLIA] = SEPOLIA_ADDRESSES, _CHAIN_TO_ADDRESSES_M[ChainId.ZKSYNC_ERA] = ZKSYNC_ERA_ADDRESSES, _CHAIN_TO_ADDRESSES_M[ChainId.ZKSYNC_ERA_SEPOLIA] = ZKSYNC_ERA_SEPOLIA_ADDRESSES, _CHAIN_TO_ADDRESSES_M[ChainId.ZKSYNC_ERA_INMEMORY] = ZKSYNC_ERA_INMEMORY_ADDRESSES, _CHAIN_TO_ADDRESSES_M[ChainId.OPTIMISM] = OPTIMISM_ADDRESSES, _CHAIN_TO_ADDRESSES_M[ChainId.ARBITRUM_ONE] = ARBITRUM_ONE_ADDRESSES, _CHAIN_TO_ADDRESSES_M[ChainId.POLYGON] = POLYGON_ADDRESSES, _CHAIN_TO_ADDRESSES_M[ChainId.POLYGON_MUMBAI] = POLYGON_ADDRESSES, _CHAIN_TO_ADDRESSES_M[ChainId.CELO] = CELO_ADDRESSES, _CHAIN_TO_ADDRESSES_M[ChainId.CELO_ALFAJORES] = CELO_ADDRESSES, _CHAIN_TO_ADDRESSES_M[ChainId.OPTIMISM_GOERLI] = OPTIMISM_GOERLI_ADDRESSES, _CHAIN_TO_ADDRESSES_M[ChainId.ARBITRUM_GOERLI] = ARBITRUM_GOERLI_ADDRESSES, _CHAIN_TO_ADDRESSES_M);
